...
public class Main implements IGui {
    ...
    public Inventory get() {
        ...
        gui.setItem(2, new Item().material(Material.STAINED_GLASS_PANE).displayName("1.11-1.12.2").lore("Left-Click <white>to use").lore("<green>RLCraft <white>Support!").get());
        gui.setItem(3, new Item().material(Material.STAINED_GLASS_PANE).displayName("1.15-1.16.5").lore("Left-Click <white>to use").get());
        gui.setItem(4, new Item().material(Material.STAINED_GLASS_PANE).displayName("1.18").lore("Left-Click <white>to use").lore("<green>StoneBlock3 <white>Support!").get());
        gui.setItem(5, new Item().material(Material.STAINED_GLASS_PANE).displayName("1.19").lore("Left-Click <white>to use").get());
        gui.setItem(6, new Item().material(Material.STAINED_GLASS_PANE).displayName("1.20").lore("Left-Click <white>to use").get());
